...
The index is regenerated automatically by a pre-commit hook and staged for you
whenever any file in `docs/` changes, so you don’t have to remember to run it
...
- Secrets management: [SECRETS.md](docs/SECRETS.md)
