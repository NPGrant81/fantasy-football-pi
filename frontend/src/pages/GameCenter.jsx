  ...
  return (
    <div className="space-y-6 pb-20 animate-fade-in">
      ...
      <div className="flex items-center gap-4">
        <Link to="/matchups" className="p-2 bg-slate-800 rounded-full text-slate-400 hover:text-white hover:bg-slate-700 transition shadow-lg">
           <FiArrowLeft size={20} />
        </Link>
