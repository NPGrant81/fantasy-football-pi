...
export default function WaiverWire({ token, ownerId }) {
  ...
  const handleClaim = async (player) => {
    ...
    try {
      ...
      await apiClient.post('/waivers/claim', { player_id: player.id, bid_amount: 0 });
  ...
  return (
    <div className="max-w-6xl mx-auto p-6">
      ...
      <div className="flex flex-col md:flex-row justify-between items-end mb-10 gap-6">
        <div>
          <h1 className="text-6xl font-black uppercase italic tracking-tighter text-white leading-none">Waiver Wire</h1>
          <p className="text-slate-500 mt-4 font-bold text-xs tracking-[0.2em]">AVAILABLE FREE AGENTS</p>
        </div>
