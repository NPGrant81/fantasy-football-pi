        ...
        <>
          <div className="mt-2 grid grid-cols-2 gap-2 text-xs text-slate-700 dark:text-slate-300">
            <div title="Remaining budget compared to league mean.">
              <div className="text-slate-500 dark:text-slate-500">Budget vs League</div>
            ...
            <div title="Spend velocity versus league spend/slot pace.">
              <div className="text-slate-500 dark:text-slate-500">Aggressiveness</div>
              <div className="font-semibold">
            ...
            <div title="Composite signal of bid discipline + roster balance + budget safety.">
              <div className="text-slate-500 dark:text-slate-500">Strategy Alignment</div>
              <div className="font-semibold text-emerald-700 dark:text-emerald-300">
                {ownerStrategyInsights.strategyAlignmentScore}
              </div>
            </div>
            <div title="Biggest roster gap versus league average by position.">
              <div className="text-slate-500 dark:text-slate-500">Positional Balance</div>
              <div className="font-semibold">
          ...
          {/* Strategy-break alerts — severity-aware */}
          {(() => {
            const severity = strategyBreakSeverity(ownerStrategyInsights);
