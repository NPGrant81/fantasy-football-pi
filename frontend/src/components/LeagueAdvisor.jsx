...
export default function ChatInterface({ initialQuery = "" }) {
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end">
      ...
      {/* 3.2 CHAT WINDOW */}
      {isOpen && (
        <div className="mb-4 w-[450px] flex flex-col bg-slate-900 border border-slate-800 rounded-2xl shadow-2xl overflow-hidden animate-fade-in-up">
          ...
          {/* MESSAGE VIEWPORT */}
          <div className="flex-1 overflow-y-auto p-4 space-y-4 h-[400px] custom-scrollbar bg-slate-950/20">
            {messages.map((msg, i) => (
