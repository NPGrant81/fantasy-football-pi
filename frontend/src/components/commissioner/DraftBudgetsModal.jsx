  ...
  useEffect(() => {
    ...
    Promise.all([
      ...
      .then(([settingsRes, ownersRes]) => {
        ...
        return apiClient.get(`/leagues/${leagueId}/budgets?year=${year}`).then((budgetsRes) => {
        ...
        <div className="mt-6 flex justify-end gap-3">
          ...
          <button
            ...
            onClick={async () => {
              ...
              setSaving(true);
              try {
                await apiClient.post(`/leagues/${leagueId}/draft-year`, { year: draftYear });
