...
vi.mock('../src/pages/Matchups', () => ({ default: () => <div>Matchups</div> }))
vi.mock('../src/pages/GameCenter', () => ({ default: () => <div>GameCenter</div> }))
vi.mock('../src/pages/CommissionerDashboard', () => ({ default: () => <div>Commissioner</div> }))
vi.mock('../src/pages/WaiverWire', () => ({ default: () => <div>Waivers</div> }))
...
describe('App (basic)', () => {
  ...
  test('uses token to fetch /auth/me and shows app when valid', async () => {
    ...
    apiClient.get.mockResolvedValue({ data: { user_id: 7, username: 'alice' } })
