...
| Keepers              | `GET /keepers`, `POST /keepers`, `POST /keepers/lock`, `DELETE /keepers/{player_id}`, `GET /keepers/admin`, `POST /keepers/admin/{owner_id}/veto`, `POST /keepers/admin/reset`, `GET/PUT /keepers/settings` | Keepers page, Commissioner settings                   |
